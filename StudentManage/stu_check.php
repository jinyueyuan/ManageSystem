...
<div class="container"style="overflow:hidden;margin:0;width:100%;padding:0px;">
    ...
    <div class="row">
        ...
        <div class="col-xs-11">
            <p class="biao"><a>首页></a><a href="stu_init.php">管理学生信息></a><a>查看学生信息</a></p>
...
<!--                利用表单显示数据-->
            ...
            <div align="center"><input type="submit" value="修改" onclick="javascript:window.location='stu_change.php?id=\'<?php echo $_GET['id']?>\' '" class="btn btn-primary"/>
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                <input type="submit" value="返回" onclick="javascript:window.location='stu_init.php';" class="btn btn-primary"/>
        </div>
        </div>
    </div>
</div>
