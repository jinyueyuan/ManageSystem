...
<div class="container" style="overflow:hidden;margin:0;width:100%;padding:0px;">
    ...
    <div class="row">
        <div class="col-xs-6">
            <p class="biao"><a>首页></a><a>管理班级信息></a><a>添加班级信息</a></p>

            <form class="form-horizontal" action="classManage.php" method="post">
                <div class="form-group">
                    <label for="grade_id" class="col-xs-3 control-label"><span style="color:red">*</span>年级：</label>

                    <div class="col-xs-6">
                        <span style="height:20px;"><?php $number=$_COOKIE['grade_id'];
                                    if($number==1)
                                        echo "高一";
                                    elseif($number==2)
                                        echo "高二";
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <input type="text" class="form-control" id="class_addr" name="class_addr">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-6">
                        <input type="submit" name="submit" value="确认提交" class="btn btn-primary"
